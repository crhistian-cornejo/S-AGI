...
import { commonChartConfig, chartColors } from "./chart-utils";
      ...
      {useGradient && (
        <defs>
          <linearGradient id={actualGradientId} x1="0" y1="0" x2="0" y2="1">
            <stop
              offset="0%"
              stopColor={stroke || chartColors.primary}
              stopOpacity={0.4}
            />
            <stop
              offset="100%"
  ...
  return (
    <RechartsLine
      ...
      dot={
        dot
          ? {
              fill: stroke || chartColors.primary,
              ...(typeof dot === "object" ? dot : {}),
            }
          : false
      }
      activeDot={
        ...
        {items.map((item, index) => (
          ...
          >
            <div
              ...
              style={{
                backgroundColor:
                  item.type === "solid" || item.type === "dashed"
...
export function ZeroReferenceLine({
  ...
  return (
    <ReferenceLine y={0} stroke={stroke} strokeDasharray={strokeDasharray} />
  );
}
