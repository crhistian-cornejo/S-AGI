...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollUpButton
        ...
        {...props}
    >
        <IconChevronUp size={16} className="shrink-0 text-muted-foreground/80" />
    </SelectPrimitive.ScrollUpButton>
))
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollDownButton
        ...
        {...props}
    >
        <IconChevronDown size={16} className="shrink-0 text-muted-foreground/80" />
    </SelectPrimitive.ScrollDownButton>
))
        ...
        >
            <span className={overlayItemIndicator}>
                <SelectPrimitive.ItemIndicator>
                    <IconCheck size={16} className="shrink-0 text-muted-foreground/80" />
                </SelectPrimitive.ItemIndicator>
            </span>
