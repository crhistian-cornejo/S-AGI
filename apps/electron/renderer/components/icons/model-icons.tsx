 ...
 */
export function ChatGPTPlusIcon({
  className,
  size = 16,
}: {
  className?: string;
...
export function CerebrasIcon({
  ...
  return (
    <svg
      ...
      className={className}
      role="img"
      aria-labelledby="cerebras-title"
    >
      <title id="cerebras-title">Cerebras</title>
      <path
        clipRule="evenodd"
        fillRule="evenodd"
 ...
 * Official Anthropic Claude logo in orange
 */
