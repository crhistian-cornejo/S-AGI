...
export function GroqIcon({
  ...
  return (
    <svg
      ...
      className={className}
      role="img"
      aria-labelledby="groq-title"
    >
      <title id="groq-title">Groq</title>
...
/**
 * Groq monochrome logo (no background, uses currentColor)
 */
export function GroqMonoIcon({
  className,
  size = 16,
}: {
  className?: string;
  ...
  return (
    <svg
      viewBox="40 30 110 140"
      width={size}
      height={size}
      fill="currentColor"
      className={className}
      role="img"
      aria-labelledby="groq-mono-title"
    >
      <title id="groq-mono-title">Groq</title>
