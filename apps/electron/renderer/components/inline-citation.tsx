...
export interface CitationData {
  id: number;
  /** Alias for id (for consistency with citationId in other interfaces) */
  citationId?: number;
  filename: string;
  pageNumber: number | null;
  text: string;
  /** Bounding box for precise PDF highlighting */
  boundingBox?: {
    x: number;
    y: number;
    width: number;
    ...
    <HoverCard.Root openDelay={100} closeDelay={150}>
      <HoverCard.Trigger asChild>
        <button
          ...
          title={
            isClickable
              ? `Abrir ${citation.filename} en pestaña PDF`
              : undefined
          }
          ...
          <div className="flex items-start gap-2 mb-2">
            <div
              className={cn(
                ...
                getExtensionColor(citation.filename)
                  .replace("border-", "bg-")
                  .replace("/20", "/30"),
              )}
            >
  ...
  return (
    <div className={cn("mt-3 pt-2 border-t border-border/30", className)}>
      <div className="flex items-center gap-1.5 flex-wrap">
        <span className="text-[10px] text-muted-foreground/50">Fuentes:</span>
            ...
            <HoverCard.Root key={filename} openDelay={100} closeDelay={150}>
              <HoverCard.Trigger asChild>
                <button
                  ...
                  title={
                    isClickable ? `Abrir ${filename} en pestaña PDF` : undefined
                  }
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {fileCitations.length} cita
                        {fileCitations.length !== 1 ? "s" : ""}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {fileCitations.map((citation) => (
                      ...
                      >
                        ...
                        {citation.text &&
                          citation.text !== "Fuente citada del documento" && (
