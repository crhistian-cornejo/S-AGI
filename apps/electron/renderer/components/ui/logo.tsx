...
// Simple version without gradient/texture for icons
export function LogoSimple({ className, size = 24, ...props }: LogoProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 79 79"
...
// Outline-only variant for subtle UI accents
export function LogoOutline({ className, size = 24, ...props }: LogoProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 79 79"
